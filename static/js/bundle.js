...
},{"./components/main":2,"marko/components":7}],2:[function(require,module,exports){
'use strict';
var marko_template = module.exports = require('marko/src/vdom').t(), components_helpers = require('marko/src/components/helpers'), marko_registerComponent = components_helpers.rc, marko_componentType = marko_registerComponent('/spartan-ide$1.0.0/components/main.marko', function () {
        return module.exports;
    }), marko_renderer = components_helpers.r, marko_defineComponent = components_helpers.c, marko_helpers = require('marko/src/runtime/vdom/helpers'), marko_createElement = marko_helpers.e, marko_const = marko_helpers.const, marko_const_nextId = marko_const('ec4b82'), marko_node0 = marko_createElement('DIV', null, '0', null, 1, 0, { i: marko_const_nextId() }).t('IDEv2');
...
},{"marko/src/components/helpers":22,"marko/src/runtime/vdom/helpers":47,"marko/src/vdom":50}],3:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":51,"error-stack-parser":4}],4:[function(require,module,exports){
...
},{"stackframe":52}],5:[function(require,module,exports){
/* jshint newcap:false */
...
},{"./src/components":23}],8:[function(require,module,exports){
...
},{"./copyProps":8}],11:[function(require,module,exports){
"use strict";
/* jshint newcap:false */
...
},{"../morphdom":32,"../runtime/RenderResult":34,"../runtime/createOut":35,"../runtime/dom-insert":36,"./ComponentsContext":13,"./event-delegation":21,"./update-manager":27,"./util":28,"complain":3,"events-light":5,"listener-tracker":6,"raptor-util/inherit":10}],12:[function(require,module,exports){
"use strict";
var repeatedRegExp = /\[\]$/;
...
},{"./KeySequence":15,"./util":28,"raptor-util/extend":9}],13:[function(require,module,exports){
"use strict";
...
},{"./GlobalComponentsContext":14}],14:[function(require,module,exports){
...
},{"./KeySequence":15,"./util":28}],15:[function(require,module,exports){
...
},{"raptor-util/extend":9}],17:[function(require,module,exports){
...
},{"./ComponentDef":12}],18:[function(require,module,exports){
module.exports = [
    /* Mouse Events */
    "click",
    "dblclick",
...
},{"./Component":11,"./State":16,"raptor-util/inherit":10}],20:[function(require,module,exports){
"use strict";
...
},{"./bubble":18,"./util":28}],22:[function(require,module,exports){
require("./");
...
},{"./":23,"./defineComponent":19,"./registry":25,"./renderer":26}],23:[function(require,module,exports){
var componentsUtil = require("./util");
...
},{"./ComponentsContext":13,"./init-components":24,"./registry":25,"./util":28}],24:[function(require,module,exports){
"use strict";
...
},{"./ComponentDef":12,"./event-delegation":21,"./registry":25,"./util":28,"warp10/finalize":53}],25:[function(require,module,exports){
var complain = 'MARKO_DEBUG' && require('complain');
...
function load(typeName, isLegacy) {
    ...
    if (!target) {
        ...
        if (target) {
            ...
            if ('MARKO_DEBUG') {
                complain('Looks like you used `require:` in your browser.json to load a component.  This requires that Marko has knowledge of how lasso generates paths and will be removed in a future version.  `marko-dependencies:/path/to/template.marko` should be used instead.');
            }
        }
        if (!target) {
...
},{"../loader":31,"./defineComponent":19,"complain":3}],26:[function(require,module,exports){
var componentsUtil = require("./util");
var componentLookup = componentsUtil.___componentLookup;
var emitLifecycleEvent = componentsUtil.___emitLifecycleEvent;
...
},{"./ComponentsContext":13,"./beginComponent":17,"./endComponent":20,"./registry":25,"./util":28,"raptor-util/copyProps":8}],27:[function(require,module,exports){
"use strict";
...
},{"../runtime/nextTick":38}],28:[function(require,module,exports){
...
},{"./loader":31,"./runtime/createOut":35}],31:[function(require,module,exports){
"use strict";
...
},{"../components/event-delegation":21,"../components/util":29,"../runtime/vdom/vdom":49,"./specialElHandlers":33}],33:[function(require,module,exports){
...
},{"./dom-insert":36}],35:[function(require,module,exports){
var actualCreateOut;
...
},{"../components/util":29,"raptor-util/extend":9}],37:[function(require,module,exports){
"use strict";
...
},{"./createOut":35,"raptor-util/extend":9}],40:[function(require,module,exports){
var EventEmitter = require("events-light");
...
},{"../../morphdom":32,"../RenderResult":34,"./vdom":49,"events-light":5}],41:[function(require,module,exports){
...
},{"./VNode":45,"raptor-util/inherit":10}],42:[function(require,module,exports){
var VNode = require("./VNode");
var inherit = require("raptor-util/inherit");
...
},{"./VNode":45,"raptor-util/inherit":10}],43:[function(require,module,exports){
var VNode = require("./VNode");
var inherit = require("raptor-util/inherit");
var extend = require("raptor-util/extend");
...
},{"./VNode":45,"raptor-util/extend":9,"raptor-util/inherit":10}],44:[function(require,module,exports){
/* jshint newcap:false */
var VNode = require("./VNode");
var inherit = require("raptor-util/inherit");
...
},{"./VNode":45,"raptor-util/inherit":10}],45:[function(require,module,exports){
/* jshint newcap:false */
function VNode() {}
...
},{"./VNode":45,"raptor-util/inherit":10}],47:[function(require,module,exports){
"use strict";
...
},{"../helpers":37,"./vdom":49,"raptor-util/extend":9}],48:[function(require,module,exports){
"use strict";
require("../../");
...
},{"../../":30,"../createOut":35,"../renderable":39,"./AsyncVDOMBuilder":40}],49:[function(require,module,exports){
var VNode = require("./VNode");
...
},{"./VComment":41,"./VComponent":42,"./VDocumentFragment":43,"./VElement":44,"./VNode":45,"./VText":46}],50:[function(require,module,exports){
module.exports = require("./runtime/vdom");

},{"./runtime/vdom":48}],51:[function(require,module,exports){
...
},{"./src/finalize":54}],54:[function(require,module,exports){
var isArray = Array.isArray;
